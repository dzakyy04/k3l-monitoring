@php
    $links = [
        ...
        ['label' => 'Input Absensi', 'route' => 'absensi.create', 'active' => 'absensi.create',
         'icon' => '<circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/>'],
        ['label' => 'Riwayat', 'route' => 'absensi.index', 'active' => 'absensi.index',
        ...
        <div class="rounded-2xl bg-white/[0.03] p-3.5">
            <div class="flex items-center gap-2.5">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-[0.6rem] font-semibold uppercase tracking-widest text-primary/80">Petugas</p>
                </div>
            </div>
